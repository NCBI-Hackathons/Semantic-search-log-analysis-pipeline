...
# App to analyze web-site search logs (internal search) - Trends by topic<br>
# Part 1. Text wrangling<br>
# **This script:** Wrangle text and match against historical file.<br>
...
quickCounts = pd.DataFrame({'Query':quickCounts})
quickCounts = quickCounts.reset_index()
quickCounts = quickCounts[quickCounts['Query'] >= 10]
quickCounts['PercentShare'] = quickCounts.Query / TotQueries * 100
...
# Add SemanticTypeName and SemanticGroup
searchLogClean.loc[searchLogClean['preferredTerm'].str.contains('Bibliographic Entity', na=False), 'SemanticTypeName'] = 'Intellectual Product'
...
searchLogClean.loc[searchLogClean['preferredTerm'].str.contains('Numeric Entity', na=False), 'SemanticTypeName'] = 'Database Accession Number'
